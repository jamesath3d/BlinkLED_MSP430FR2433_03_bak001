...
#define _CB_PR_1hex(str1,str2,idx3)         { _uart_p1_5_tx_only_put_str(str1);_uart_p1_5_tx_only_put_str("0x"); _uart_p1_5_tx_only_put_hex_u8(idx3); _uart_p1_5_tx_only_put_str(str2); }
#define _CB_PR_1hex_rn(str1,str2,idx3)      { _CB_PR_1hex(str1,str2,idx3); _uart_p1_5_tx_only_put_rn(); }
