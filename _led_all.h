...
#define _LED_red_on()             _LED_red_TO_1()
#define _LED_red_off()            _LED_red_TO_0()
...
#define _LED_green_on()             _LED_green_TO_1()
#define _LED_green_off()            _LED_green_TO_0()
